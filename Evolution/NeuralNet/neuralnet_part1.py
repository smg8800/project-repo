...
class NeuralNet(nn.Module):
    def __init__(self, lrate, loss_fn, in_size, out_size):
        ...
        self.lrate = lrate
        self.net = torch.nn.Sequential(torch.nn.Linear(in_size, 162), torch.nn.ReLU(), torch.nn.Linear(162,out_size))
        self.optimizer = optim.SGD(self.net.parameters(),self.lrate)
